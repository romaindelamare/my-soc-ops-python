...
# Easy: ~40-50% of squares so every comfort level can participate
# Medium: everyday dev situations that spark stories
# Bold/Wildcard: playful action-based prompts

TECH_LIFE_QUESTIONS: list[str] = [
    # ── Easy ────────────────────────────────────────────────────────────────
    "Uses dark mode",
    ...
    "Has a to-do list that never gets shorter",
    # ── Medium ───────────────────────────────────────────────────────────────
    ...
    "Debugged for 2+ hours only to find a typo",
    'Has a side project that has been "almost done" for months',
